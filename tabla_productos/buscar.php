...
if($_POST['busca']== ""){
    ...
    elseif ($buscar = $_POST['busca']){
        ...
        $sql=("SELECT * FROM productos,proveedor WHERE codigo=".$_POST["busca"]." AND productos.nit= proveedor.nit");
        ...
        if ($registro){
            ...
            $clave=     $registro['precio'];
            $usuario=   $registro['existencia'];
            $correo=    $registro['fecha'];
