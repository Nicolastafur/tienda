...
<?php
	...
	$sql_total="SELECT * FROM usuario where id_rol <=4";//muestra los 3 primeros, primer parametro indica en que posición impieza en este caso posición 0, el segundo parametro cuantos registros quiere mostrar en este caso 3 registros
	...
	$registros=$base->query("SELECT * FROM usuario where id_rol <=4 LIMIT $empieza, $registros")->fetchALL(PDO::FETCH_OBJ);
	
?>
<h3>PANEL DE OPCIONES USUARIOS</h3>
    <form method="post" action="buscar.php">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a id="q1" href="eliminar.php?id=<?php echo $move->id_usu?> & nomb=<?php echo $move->nombre_usuario?>">
					    <img src="../imagenes/borrar.png" alt="eliminar">
                    </a>
                </td>
                <td>
                    <a id="q2" href="modificar.php?id=<?php echo $move->id_usu?> & nomb=<?php echo $move->nombre_usuario?>">
